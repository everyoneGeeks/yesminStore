      ...
      الشحن
        ...
        <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                <a href="/admin/orders/accept" class="nav-link {{ Request::is(Route::currentRouteName() == 'orders.accept') ? 'active' : '' }}">
                    <i class="fa fa-circle-o nav-icon"></i>
                    <p>الطلبات قيد التوصيل </p>
                  </a>
                </li>
                <li class="nav-item">
                <a href="/admin/orders/done" class="nav-link {{ Request::is(Route::currentRouteName() == 'orders.done') ? 'active' : '' }}">
                    <i class="fa fa-circle-o nav-icon"></i>
                    <p> الطلبات المنتهية </p>
                  </a>
                </li>
                <li class="nav-item">
                <a href="/admin/orders/cancel" class="nav-link {{ Request::is(Route::currentRouteName() == 'orders.cancel') ? 'active' : '' }}">
                    <i class="fa fa-circle-o nav-icon"></i>
                  ...
                  <li class="nav-item">
                <a href="/admin/orders/ComplainOrders" class="nav-link {{ Request::is(Route::currentRouteName() == 'orders.ComplainOrders') ? 'active' : '' }}">
                    <i class="fa fa-circle-o nav-icon"></i>
                    <p>  شكاوي الطلبات  </p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                <a href="/admin/orders/returnOrder" class="nav-link {{ Request::is(Route::currentRouteName() == 'orders.returnOrder') ? 'active' : '' }}">
                    <i class="fa fa-circle-o nav-icon"></i>
...
ادارة الاعلانات
 ...
 اكواد الخصم
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                <a href="/admin/appSetting/links" class="nav-link {{ Request::is(Route::currentRouteName() == 'appSetting.links') ? 'active' : '' }}">
                    <i class="fa fa-circle-o nav-icon"></i>
                ...
                <li class="nav-item">
                <a href="/admin/appSetting/close" class="nav-link {{ Request::is(Route::currentRouteName() == 'appSetting.close') ? 'active' : '' }}">
                    <i class="fa fa-circle-o nav-icon"></i>
                    <p>    غلق الموقع  </p>
                  </a>
                </li>
