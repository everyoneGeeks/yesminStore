...
<?php $__env->startComponent('components.panel',['subTitle'=>'ادارة الطلبات الجديدة ']); ?>
...
<th>
<a href="/admin/order/info/<?php echo e($order->id); ?>" class="btn btn-block btn-primary btn-flat">عرض</a></th>
<th>
<a href="/admin/order/accept/<?php echo e($order->id); ?>" class="btn btn-block btn-success btn-flat">موافقة </a>

</th>
<th>
<a href="/admin/order/cancel/<?php echo e($order->id); ?>" class="btn btn-block btn-danger btn-flat">رفض </a>
