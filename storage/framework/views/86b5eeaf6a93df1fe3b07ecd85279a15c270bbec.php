...
<div class="login-form register">
            ...
            <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="first_name"><?php echo e(App::getLocale() == 'ar' ? "الاسم الاول" : "first name"); ?></label>
                            <input type="text" class="form-control" id="first_name"  name="first_name" placeholder="<?php echo e(App::getLocale() == 'ar' ? 'الاسم الاول' : 'first name'); ?>">
                ...
                <?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="last_name"><?php echo e(App::getLocale() == 'ar' ? "الاسم الاخير " : "last name"); ?></label>
                            <input type="text" class="form-control" id="last_name"  name="last_name" placeholder="<?php echo e(App::getLocale() == 'ar' ? 'ادخل الاخير ' : 'last name'); ?>">
                ...
                <?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="<?php echo e(App::getLocale() == 'ar' ? '   البريد الإلكترونى  ' : 'Your Email  '); ?>">
                ...
                <?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="phone"><?php echo e(App::getLocale() == 'ar' ? 'رقم الهاتف (اختياري)' : 'Phone (optional)'); ?></label>
                            <input type="tel" class="form-control" id="phone" name="phone" placeholder="<?php echo e(App::getLocale() == 'ar' ? ' رقم الهاتف ' : 'Phone Number   '); ?> ">
                ...
                <?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" name="password" placeholder="<?php echo e(App::getLocale() == 'ar' ? '   كلمة المرور ' : 'Password '); ?>">
                ...
                <?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="password_confirmation"><?php echo e(App::getLocale() == 'ar' ? ' تاكيد  كلمة المرور' : ' Password confirmation'); ?></label>
                            <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="<?php echo e(App::getLocale() == 'ar' ? '  تاكيد  كلمة المرور  ' : 'Password confirmation '); ?>">
    ...
    top: 6px;
">
                <label class="form-check-label" for="exampleCheck1" style="<?php echo e(App::getLocale() == 'ar' ?  'margin-right: 20px;' : ''); ?>" ><?php echo e(App::getLocale() == 'ar' ? '  اوافق علي  ' : 'I accept the '); ?>

                 <a   data-toggle="modal" data-target="#myModal"  style="color: #61bfd0;"><?php echo e(App::getLocale() == 'ar' ? ' الشروط والأحكام ' : 'Privacy policy
'); ?></a>
    ...
    margin-bottom: 0px;
    font-size: medium;
">    <?php echo e(App::getLocale() == 'ar' ? '   يجب الموافقة علي الشروط والأحكام  ' : 'Privacy policy
'); ?></p>
                <?php endif; ?>
<!-- Modal -->
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h4 class="modal-title" id="myModalLabel"><?php echo e(App::getLocale() == 'ar' ? '  سياسة الخصوصية ' : 'Privacy policy
'); ?></h4>
...
إن كان لديك أى سؤال لا تترد فالتواصل معنا عبر صفحتنا على فيس بوك او الشات على موقعنا
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(App::getLocale() == 'ar' ? ' اغلاق  ' : 'Close'); ?></button>
      </div>
    </div>
  </div>
</div>
                ...
                <button type="submit" class="btn btn-block "><?php echo e(App::getLocale() == 'ar' ? '  انشاء الحساب  ' : 'Create Account'); ?></button>
            </form>
        </div>
    </div>
