...
<img src="<?php echo e(asset('/img/Towipi-logo.svg')); ?>" alt="Logo" style="
    display: flex;
">
    </div>
      <div class="row" style="
...
<a type="button" href="/signin" class="btn btn-secondary "  style="
    ...
    border-color: #F495BE;
"><?php echo e(App::getLocale() == 'ar' ? "تسجيل ":"sign in"); ?></a>
...
<a type="button" href="/signup" class="btn btn-secondary" style="
    background-color: #F495BE;
    border-color: #F495BE;
"><?php echo e(App::getLocale() == 'ar' ? "انشاء حساب جديد":"sign up"); ?></a>
