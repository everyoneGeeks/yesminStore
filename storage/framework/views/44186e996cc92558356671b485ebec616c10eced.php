...
<?php $__env->startComponent('components.panel',['subTitle'=>'  الشكاوي   ']); ?>
<?php if($orders->isEmpty()): ?>

<?php $__env->startComponent('components.empty',['section'=>'الشكاوي ']); ?> <?php echo $__env->renderComponent(); ?>
...
<tr>
<th><a href="/admin/complain/info/<?php echo e($order->id); ?>"> <?php echo e($order->id); ?> </a></th>    
<th><?php echo e($order->title); ?></th>
<th><?php echo e($order->subject); ?></th>
<th><?php echo e(Carbon\Carbon::parse($order->created_at)->format('Y-m-d')); ?></th>
<?php if($order->status == 'open'): ?>
<th><a href="/admin/complain/status/<?php echo e($order->id); ?>" class="btn btn-secondary"> غلق </a></th>
<?php else: ?> 
<th><a href="/admin/complain/status/<?php echo e($order->id); ?>" class="btn btn-success"> فتح </a></th>
...
<?php echo $__env->make('layoutDashboard.app',['title'=>'شكاوي '], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>