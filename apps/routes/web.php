...
Route::get('/users/deactivate','usersControllers@deactivate')->name('users.deactivate');
...
*/
Route::get('/subcategoies','subcategoiesController@list_caketools')->name('subcategoies');
Route::get('/subcategoies/party','subcategoiesController@list_party')->name('subcategoies.party');
...
Route::get('/all/orders','ordersController@All_orders')->name('all.orders');
...
Route::get('/ad/delete/{id}','Advertisements@delete')->name('ad.delete')->where('id', '[0-9]+')->middleware('role:ad,edit');
...
| this will handle all ads part
*/
Route::get('/costomerPhoto/edit/{id}','costomerPhotoController@formEdit')->name('costomer.edit')->where('id', '[0-9]+')->middleware('role:ad,edit');
Route::post('/costomerPhoto/edit/{id}','costomerPhotoController@submitEdit')->name('costomer.edit.submit')->where('id', '[0-9]+')->middleware('role:ad,edit');
Route::get('/costomerPhoto/add','costomerPhotoController@formAdd')->name('costomer.add')->middleware('role:ad,add');
Route::post('/costomerPhoto/add','costomerPhotoController@submitAdd')->name('costomer.add.submit')->middleware('role:ad,add');
Route::get('/costomerPhoto/delete/{id}','costomerPhotoController@delete')->name('costomerPhoto.delete')->where('id', '[0-9]+')->middleware('role:ad,edit');
...
| this will handle all ads part
*/
Route::get('/costomerRate/edit/{id}','costomerRateController@formEdit')->name('costomersRate.edit')->where('id', '[0-9]+')->middleware('role:ad,edit');
Route::post('/costomerRate/edit/{id}','costomerRateController@submitEdit')->name('costomersRate.edit.submit')->where('id', '[0-9]+')->middleware('role:ad,edit');
Route::get('/costomerRate/add','costomerRateController@formAdd')->name('costomersRate.add')->middleware('role:ad,add');
Route::post('/costomerRate/add','costomerRateController@submitAdd')->name('costomersRate.add.submit')->middleware('role:ad,add');
Route::get('/costomerRate/delete/{id}','costomerRateController@delete')->name('costomersRate.delete')->where('id', '[0-9]+')->middleware('role:ad,edit');
