...
{
/**  
* show list of subCategory caketools
* -*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
* @author ಠ_ಠ Abdelrahman Mohamed <abdomohamed00001@gmail.com>
*/
public function list_caketools(){

    $subCategories=subCategory::where('category_id',1)->with('category')->get();
    return view('pages.subCategory.list',compact('subCategories'));
    }
    
    
/**  
* show list of subCategory party supplies
* -*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
* @author ಠ_ಠ Abdelrahman Mohamed <abdomohamed00001@gmail.com>
*/
public function list_party(){

    $subCategories=subCategory::where('category_id',2)->with('category')->get();
    return view('pages.subCategory.list',compact('subCategories'));
    }
