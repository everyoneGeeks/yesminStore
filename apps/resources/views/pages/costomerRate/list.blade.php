...
<th><a href="/admin/costomerPhoto/edit/{{$ad->id}}" class="btn btn-block btn-info btn-flat"> تعديل </a></th>
<th><a href="/admin/costomerPhoto/edit/{{$ad->id}}" class="btn btn-block btn-danger btn-flat"> حذف </a></th>
        </tr>
...
<th><a href="/admin/costomerRate/edit/{{$ad->id}}" class="btn btn-block btn-info btn-flat"> تعديل </a></th>
<th><a href="/admin/costomerRate/edit/{{$ad->id}}" class="btn btn-block btn-danger btn-flat"> حذف </a></th>
        </tr>
...
<a  href="/admin/costomerRate/add" class="btn btn-block btn-success btn-lg"> <i class="fa fa-plus" aria-hidden="true"></i> اضافة  صورة 2   </a>
</div>
@endslot
