...
<img src="{{asset($ad->image)}}" width=150px height="150px">
          ...
          <form role="form" action="{{route('costomersRate.edit.submit',$ad->id)}}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
...
<label for="InputFile"> صوره 3</label>
